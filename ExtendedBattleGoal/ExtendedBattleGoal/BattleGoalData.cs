...
{
    class BattleGoalData
    {
        private static Dictionary<int, List<string>> BattleGoalDict = new Dictionary<int, List<string>>();

        public enum BattleGoalListOrder:int
        {
            BatGoalName = 0,
            BatGoalDescription = 1,
            BatGoalChecks = 2
        }
        ...
        public List<string> GetData( int ChosenBattleGoal )
        {
            List<string> RetList = new List<string>();

            RetList.Add(BattleGoalDict[ChosenBattleGoal][(int)BattleGoalListOrder.BatGoalName]);
            RetList.Add(BattleGoalDict[ChosenBattleGoal][(int)BattleGoalListOrder.BatGoalDescription]);
            RetList.Add(BattleGoalDict[ChosenBattleGoal][(int)BattleGoalListOrder.BatGoalChecks]);
