...
namespace ExtendedBattleGoal
{
    ...
    {
        Dictionary<int, List<string>> BattleGoalDict = new Dictionary<int, List<string>>();
        public MainPage()
        {
            InitializeComponent();
        ...
        void Button_Clicked(object sender, System.EventArgs e)
        {
            ...
            BatGoalName0.Text = BattleGoalDict[listBatGoalNum[0]][0];
            BatGoalDesc0.Text = BattleGoalDict[listBatGoalNum[0]][1];
            BatGoalChecks0.Text = BattleGoalDict[listBatGoalNum[0]][2];
            BatGoalName1.Text = BattleGoalDict[listBatGoalNum[1]][0];
            BatGoalDesc1.Text = BattleGoalDict[listBatGoalNum[1]][1];
            BatGoalChecks1.Text = BattleGoalDict[listBatGoalNum[1]][2];
        }
    }
}
